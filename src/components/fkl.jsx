    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-blue-100">
            ...
            <div className="bg-blue-500 w-80 p-6 rounded-xl text-white">
                ...
                {/* Search Bar */}
                <form onSubmit={(e) => { e.preventDefault(); search(city) }} className="relative flex items-center">
                    <input
                        type="text"
                        placeholder="Search"
                        value={city}
                ...
                <div className="flex flex-col items-center mt-6">
                    ...
                    <h1 className="text-6xl font-semibold">
                        {weatherData ? Math.round(weatherData.temp) : 21}°C
                    </h1>
                    <p className="text-2xl mt-1">{weatherData ? weatherData.name : 'New York'}</p>
                    ...
                    <div className="flex justify-between w-full mt-6 px-2">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-semibold">{weatherData ? weatherData.humidity : 67}%</p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-semibold">
                                    {weatherData ? weatherData.windSpeed.toFixed(2) : 2.06} Km/h
                                </p>
